...
%Scale factor computation and error computation have been re-written. Old
%code is still present and commented out if needed. The new code allows for
%a more accurate scale factor as well as a more accurate error. 
%--Mattea Welch
...
%Re-written scale factor computation
if(doScale)
    a = []; b = [];
    for i=1:Na
        a(:,i) = R*An(:,i);
